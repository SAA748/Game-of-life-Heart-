       ...
       '''
        ...
        for i in range(self.n):
            ...
            for j in range(self.m):
                ...
                elif i == av_n - 3 and (av_m - 4 < j < av_m + 5):
                    self.a[av_n - 3].append(1)
                elif i == av_n - 2 and (av_m - 4 < j < av_m + 6):
                    self.a[av_n - 2].append(1)
                elif i == av_n - 1 and (av_m - 3 < j < av_m + 7):
                    self.a[av_n - 1].append(1)
                elif i == av_n  and (av_m - 2 < j < av_m + 8):
